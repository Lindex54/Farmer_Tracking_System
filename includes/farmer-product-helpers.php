...
if (!function_exists('ensureFarmerProductTables')) {
    function ensureFarmerProductTables($con)
    {
        if (!$con) {
            return false;
        }
...
if (!function_exists('marketplaceImageUrl')) {
    function marketplaceImageUrl($imagePath, $fallback = 'assets/images/blank.gif')
    {
        $imagePath = trim((string)$imagePath);
        return $imagePath !== '' ? $imagePath : $fallback;
    }
}

if (!function_exists('formatMarketMoney')) {
