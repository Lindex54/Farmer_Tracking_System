...
if($user && isset($user['contactno']) && $user['contactno']==$contact)
{
...
$extra="forgot-password.php";
$stmt = mysqli_prepare($con, "UPDATE users SET password = ? WHERE email = ? AND contactno = ?");
if ($stmt) {
mysqli_stmt_bind_param($stmt, 'sss', $password, $email, $contact);
